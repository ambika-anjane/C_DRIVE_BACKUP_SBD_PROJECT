...
class ProfileYAML(Model):
    ...
    def colored_is_published(self):
        if self.name:
            cell_html = '<span style="color: red;">self.name</span>'
        else:
...
class GitRepo(Model):
    ...
    # def colored_is_published(self):
    #     if self.name:
    #         cell_html = '<span style="color: firebrick;">self.name</span>'
    #     if self.url:
    #         cell_html = '<span style="color: firebrick;">self.url</span>'
    #     if self.ssh_key:
    #         cell_html = '<span style="color: firebrick;">self.ssh_key</span>'
    #     else:
    #         cell_html = '<span>%s</span>'
    #     # for below line, you may consider using 'format_html', instead of python's string formatting
    #     return format_html(self.name)
...
#         GitRepo, on_delete=models.CASCADE
#         )
